/*
 * This file defines OrganizerDashboardActivity, an Android activity used by the Scene app.
 * It contains the organizer dashboard, event list, analytics summary, and bottom navigation.
